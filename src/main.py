...
# Все функции бота (start, new_topic, handle_text_input, list_topics, mark_done, handle_unknown)
# остаются точно такими же как в вашем рабочем коде - НЕ МЕНЯЙТЕ ИХ!
